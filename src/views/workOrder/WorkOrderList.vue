  ...
  <v-container fluid>
    <v-card class="ma-3">
      <v-row class="mt-5 ml-5 mr-5">
        <v-col cols="12" md="12">
          <v-toolbar flat>
            <v-toolbar-title>Production Order : </v-toolbar-title>
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: "QTY Receive", value: "it_qty" },
      { text: "QTY Remain", value: "new_qty_remain" },
      { text: "Batch Receive", value: "it_batch" },
  ...
  methods: {
    ...
    async onSearch() {
      ...
      let qr = "";
      if (this.select_doc_status == null || this.select_doc_status == "") {
        qr = "";
      } else {
