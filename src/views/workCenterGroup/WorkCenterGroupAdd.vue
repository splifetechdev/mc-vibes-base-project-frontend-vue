                ...
                <div v-if="activetab === 1 && callsoopentab == true" class="tabcontent">
                  <v-row class="mb-n6">
                    <v-col cols="12" sm="12" md="4">
                      <v-text-field autofocus v-model="itemadd.work_center_group_id" label="Work Center Group *" outlined
                        dense></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="12" md="4">
...
export default {
  ...
  async mounted() {
    ...
    // console.log("udgroup.WORK_CENTER_GROUP", udgroup.WORK_CENTER_GROUP);
  ...
  methods: {
    ...
    async savedata() {
      ...
      const res_add = await api.addWorkCenterGroup(this.itemadd);
